...
"""DB manager help:
    ...
    db_manager.py alarms <set/get> <all/day> <name>
        Edit or get data from an alarm.
        set:
            db_manager.py alarms set all <name> <value>
            "all" access to all the alarms of the week
            "day" access to a specific day:
                 db_manager.py alarms set day <name> <value> <day number>
        get:
            db_manager.py alarms get all <name> <value>
            "all" access to all the alarms of the week
            "day" access to a specific day:
                 db_manager.py alarms get day <name> <day number>
